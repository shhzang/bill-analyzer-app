              ...
              {analysisReport && !isAnalyzing && (
                <>
                  <Button
                    ...
                    className="flex-1 bg-neon-cyan hover:bg-neon-cyan/80 text-white font-bold py-4 sm:py-5 text-lg sm:text-xl rounded-lg transition-all duration-200 hover:shadow-xl hover:shadow-neon-cyan/60 active:scale-95 border-2 border-neon-cyan/30"
                  >
                    <span className="text-xl mr-2">👁️</span>Preview Report
                  </Button>
                  <Button
                    onClick={handleDownloadReport}
                    className="flex-1 bg-neon-pink hover:bg-neon-pink/80 text-white font-bold py-4 sm:py-5 text-lg sm:text-xl rounded-lg transition-all duration-200 hover:shadow-xl hover:shadow-neon-pink/60 active:scale-95 border-2 border-neon-pink/30"
                  >
      ...
      <Dialog open={showPreview} onOpenChange={setShowPreview}>
        <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto bg-[#1a1a2e] border-neon-cyan/30">
          ...
          <div className="flex gap-3 mt-6 pt-4 border-t border-neon-cyan/20">
            <Button
              onClick={handleDownloadReport}
              className="flex-1 bg-neon-pink hover:bg-neon-pink/80 text-white font-bold py-3 sm:py-4 text-base sm:text-lg rounded-lg transition-all duration-200 hover:shadow-lg hover:shadow-neon-pink/60 active:scale-95 border-2 border-neon-pink/30"
            >
              ⬇️ Download Report
            </Button>
            <Button
              onClick={() => setShowPreview(false)}
              className="flex-1 bg-neon-cyan hover:bg-neon-cyan/80 text-white font-bold py-3 sm:py-4 text-base sm:text-lg rounded-lg transition-all duration-200 hover:shadow-lg hover:shadow-neon-cyan/60 active:scale-95 border-2 border-neon-cyan/50"
            >
              ✕ Close
            </Button>
          </div>
